...
public class XmDiff implements Diff {
  ...
  public void xmdiff(String f1, String f2)
    ...
    try {
      ...
      System.out.println("Recover has barfed");
    }
    fA.close();
    fB.close();
  ...
  public static void PrintPath(ArrayList path, RandomAccessFile file, int depth)
      throws IOException {
  ...
  /*
	...
	*/
    ...
    while (eventType1 != XmlPullParser.START_TAG && eventType1 != XmlPullParser.TEXT
        && eventType1 != XmlPullParser.END_DOCUMENT)
    ...
    do {
      ...
      while (eventType1_next != XmlPullParser.START_TAG && eventType1_next != XmlPullParser.TEXT
          && eventType1_next != XmlPullParser.END_DOCUMENT) {
      ...
      if (eventType1 == XmlPullParser.START_TAG || eventType1 == XmlPullParser.TEXT) {
        ...
        do {
          ...
          while (eventType2 != XmlPullParser.START_TAG && eventType2 != XmlPullParser.TEXT
